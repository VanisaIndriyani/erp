...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Kas Transfer</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('akuntansi.kas_transfer.create') }}" class="btn btn-sm btn-info text-white">
            <i class="bi bi-arrow-left-right"></i> Tambah Transfer
        </a>
    </div>
</div>
...
<div class="card card-dashboard">
    <div class="card-body">
        <!-- Search & Filter -->
        <form action="{{ route('akuntansi.kas_transfer.index') }}" method="GET" class="mb-3">
            <div class="row g-2">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                     <a href="{{ route('akuntansi.kas_transfer.index') }}" class="btn btn-sm btn-secondary w-100"><i class="bi bi-arrow-clockwise"></i> Reset</a>
                </div>
            </div>
        </form>
            ...
            <table class="table table-hover table-sm">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Keterangan</th>
                        <th width="20%">Dari (Kredit)</th>
                        <th width="20%">Ke (Debit)</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle fw-bold text-info">{{ $j->no_ref }}</td>
                        ...
                        <td class="align-middle text-end fw-bold text-info">
                            Rp {{ number_format($debit ? $debit->debit : 0, 0, ',', '.') }}
                        </td>
                        <td class="align-middle text-center">
                            <form action="{{ route('akuntansi.kas_transfer.destroy', $j->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus transaksi ini?')">
                                @csrf
                                @method('DELETE')
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            ...
                            <h6 class="fw-bold">Belum ada data transfer kas</h6>
                            <p class="small mb-0">Silakan tambahkan transaksi transfer baru.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
