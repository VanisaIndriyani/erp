...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Item Keluar (Non-Penjualan)</h1>
</div>

<div class="card card-dashboard">
    <div class="card-body">
        <form action="{{ route('persediaan.storeKeluar') }}" method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-4">
                    <label class="form-label">No Referensi</label>
                    <input type="text" name="no_referensi" class="form-control" value="{{ $no_ref }}" required>
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="keterangan" class="form-control" placeholder="Contoh: Rusak, Expired, Hilang, dll">
                </div>
            </div>
