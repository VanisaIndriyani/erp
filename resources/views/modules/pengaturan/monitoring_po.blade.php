...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom d-print-none">
        <h1 class="h2">Monitoring PO</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <button type="button" class="btn btn-sm btn-outline-secondary me-2" onclick="window.print()">
                <i class="bi bi-printer"></i> Cetak / PDF
            </button>
            <button type="button" class="btn btn-sm btn-outline-success" onclick="exportTableToExcel('tableMonitoringPO', 'Monitoring_PO_Sparepart_Hose')">
    ...
    <div class="print-header">
        <div class="d-flex align-items-center justify-content-center mb-2">
            ...
            <div class="text-start">
                ...
                <p class="mb-0 fw-bold" style="font-size: 18px; margin-top: 5px;">MONITORING PURCHASE ORDER</p>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 d-print-none">
        ...
        <div class="card-body">
            <form action="{{ route('pengaturan.monitoring_po') }}" method="GET" class="row g-3">
                <div class="col-md-3">
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle mb-0" id="tableMonitoringPO">
                    <thead class="bg-light">
                        <tr>
                            <th class="px-3 py-3">Tanggal</th>
                            <th class="py-3">No PO / Invoice</th>
                    ...
                    <tbody>
                        ...
                        @forelse($data as $po)
                            @foreach($po->details as $detail)
                                ...
                                @endphp
                                <tr>
                                    <td class="px-3">{{ \Carbon\Carbon::parse($po->tanggal)->format('d/m/Y') }}</td>
                                    <td>
                                        <div class="fw-bold">{{ $po->no_invoice }}</div>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">
                                    ...
                                    Tidak ada data pembelian Sparepart/Hose pada periode ini.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
