...
<div class="container-fluid px-4">
    <div class="print-header">
        <div class="d-flex align-items-center justify-content-center mb-2">
            ...
            <div class="text-start">
                ...
                <p class="mb-0 fw-bold" style="font-size: 18px; margin-top: 5px;">LAPORAN PEMBELIAN</p>
        ...
        <div class="row mb-3 mt-4 border-bottom pb-3">
            <div class="col-6">
                <table class="table table-sm table-borderless mb-0">
                    <tr>
                        <td class="fw-bold" width="150">Total Transaksi</td>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 mt-3 d-print-none">
        <h2 class="mb-0 fw-bold text-dark">Laporan Pembelian</h2>
        ...
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('laporan.pembelian') }}" method="GET" id="filterForm">
                        ...
                        <!-- Supplier -->
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-muted small text-uppercase">Supplier</label>
                            <div class="row g-2">
                                <div class="col-6">
                                    <select class="form-select bg-light" name="supplier_id_start">
                                ...
                                <div class="col-6">
                                    <select class="form-select bg-light" name="supplier_id_end">
                                        <option value="">-- Sampai Supplier --</option>
                                        @foreach($suppliers as $s)
                                            <option value="{{ $s->id }}">{{ $s->nama }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <!-- User -->
                            <div class="col-md-6 mb-4">
                                <label class="form-label fw-semibold text-muted small text-uppercase">User Input</label>
                ...
                <div class="card-body p-4 d-flex flex-column">
                    <div class="list-group list-group-radio mb-auto gap-2">
                        <label class="list-group-item d-flex gap-3 rounded-3 border">
                            ...
                            <span>
                                <strong class="d-block">Laporan Pembelian Rekap</strong>
                                <small class="text-muted">Ringkasan pembelian per transaksi</small>
                            </span>
                        </label>
                        <label class="list-group-item d-flex gap-3 rounded-3 border">
                            <input class="form-check-input flex-shrink-0" type="radio" name="report_type" value="detail">
                            <span>
                                <strong class="d-block">Laporan Pembelian Detail</strong>
                                <small class="text-muted">Rincian item setiap transaksi pembelian</small>
                            </span>
                        </label>
                        <label class="list-group-item d-flex gap-3 rounded-3 border">
                            <input class="form-check-input flex-shrink-0" type="radio" name="report_type" value="harian">
                            <span>
                                <strong class="d-block">Laporan Pembelian Harian</strong>
                                <small class="text-muted">Total pembelian per hari</small>
                            </span>
                        </label>
                        <label class="list-group-item d-flex gap-3 rounded-3 border">
                            <input class="form-check-input flex-shrink-0" type="radio" name="report_type" value="gudang">
                            <span>
                                <strong class="d-block">Laporan Rekap Per Gudang</strong>
                                <small class="text-muted">Analisa pembelian berdasarkan lokasi gudang</small>
                            </span>
                        </label>
                    </div>
                    ...
                    <div class="mt-4 d-grid gap-2">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                <button type="button" class="btn btn-outline-success w-100 rounded-pill" onclick="exportTableToExcel('tablePembelian', 'Laporan_Pembelian')">
    ...
    <div class="card border-0 shadow-sm rounded-4 mt-4">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover table-striped align-middle mb-0" id="tablePembelian">
...
<style>
    ...
    @media print {
        ...
        .table:not(.table-borderless) th, .table:not(.table-borderless) td { 
