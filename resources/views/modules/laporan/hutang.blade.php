...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom d-print-none">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="exportTableToExcel('tableHutang', 'Laporan_Hutang')">
    ...
    <div class="print-header">
        <div class="d-flex align-items-center justify-content-center mb-2">
            ...
            <div class="text-start">
                ...
                <p class="mb-0 fw-bold" style="font-size: 18px; margin-top: 5px;">LAPORAN HUTANG BEREDAR</p>
    ...
    <div class="row d-print-none">
        ...
        <div class="col-md-9 mb-4">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body">
                    <form action="{{ route('laporan.hutang') }}" method="GET" id="filterForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                <div class="d-grid gap-2 w-100">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary" onclick="window.location.href='{{ route('laporan.hutang') }}'">
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="list-group list-group-flush rounded-bottom-4">
                    <label class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer {{ request('type', 'beredar') == 'beredar' ? 'active-type' : '' }}">
                        ...
                        <div>
                            <div class="fw-bold">Hutang Beredar</div>
                            <div class="small text-muted">Sisa tagihan per supplier</div>
                        </div>
                    </label>
                    <label class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer {{ request('type') == 'pembayaran' ? 'active-type' : '' }}">
                        ...
                        <div>
                            ...
                            <div class="small text-muted">History pembayaran hutang</div>
                        </div>
                    </label>
                </div>
            </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover table-striped mb-0 align-middle" id="tableHutang">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold">{{ $item->supplier->nama ?? '-' }}</td>
                        ...
                        <tr class="bg-light fw-bold fs-6">
                            <td colspan="4" class="text-end px-4 py-3">GRAND TOTAL</td>
    ...
    <div class="alert alert-info text-center rounded-4 shadow-sm">
        <i class="bi bi-info-circle me-2"></i> Tidak ada data hutang beredar untuk periode/filter ini.
    </div>
    @endif
