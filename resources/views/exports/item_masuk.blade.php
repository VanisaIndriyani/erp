<table>
    <thead>
        ...
        <tr>
            <th colspan="7" style="text-align: center; font-weight: bold; font-size: 14pt;">LAPORAN TRANSAKSI ITEM MASUK</th>
        </tr>
        <tr>
            <th colspan="7"></th>
        </tr>
        <tr>
            ...
            <th style="font-weight: bold; border: 1px solid #000000; background-color: #f2f2f2;">Gudang Tujuan</th>
            <th style="font-weight: bold; border: 1px solid #000000; background-color: #f2f2f2;">Total Nilai</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000000;">{{ $row->gudang_tujuan }}</td>
            <td style="border: 1px solid #000000;">{{ number_format($row->total_nilai, 0, ',', '.') }}</td>
